...
const form = useForm({
    name: '',
    business_name: '',
    price_tier: 1, // Por defecto Lista A
    email: '',
    phones: '',
    street_address: '',
    neighborhood: '',
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
                    <div class="p-8 border-b border-gray-200">
                        ...
                        <div class="flex justify-between items-center mb-8">
                            <h2 class="text-2xl font-bold text-gray-800">Registrar Nuevo Cliente</h2>
                            ...
                            <div class="mb-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="col-span-1">
                                        ...
                                        <input v-model="form.business_name" type="text" placeholder="Opcional"
                                            class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    ...
                                    <div class="col-span-1 md:col-span-2">
                                        ...
                                        <p class="text-xs text-gray-400 mt-1">Determina qué precios verá este cliente al venderle.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input v-model="form.phones" type="text" placeholder="Ej: 333-123-4567, 331-..." 
                                            class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            ...
                            <div class="mb-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
                                    ...
                                    <div class="md:col-span-6 mt-2">
                                        ...
                                        <textarea v-model="form.references" rows="2" placeholder="Entre calles, color de fachada, etc." 
