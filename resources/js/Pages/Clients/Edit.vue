...
const props = defineProps({
    client: Object, // El cliente a editar
});

const form = useForm({
    name: props.client.name,
    business_name: props.client.business_name,
    price_tier: props.client.price_tier, // Por defecto precio público
    ...
    <AuthenticatedLayout>
        <div class="max-w-4xl mx-auto py-10">
            <div class="bg-white p-8 rounded-lg shadow border">
                <h2 class="text-xl font-bold mb-6 text-gray-800">Editar Cliente: {{ client.name }}</h2>
