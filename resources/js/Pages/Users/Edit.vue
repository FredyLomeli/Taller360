            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="mb-1 mt-6 pt-4 border-t border-gray-100">
                            <p class="text-xs text-gray-500 mb-4">Deja la contraseña en blanco si no quieres cambiarla.</p>
                        </div>

                        <div class="mb-4">
                            <label class="block font-medium text-sm text-gray-700">Nueva Contraseña</label>
                            <input v-model="form.password" type="password" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 mt-1" placeholder="•••••••• (sin cambios)">
                            <div v-if="form.errors.password" class="text-red-500 text-xs mt-1">{{ form.errors.password }}</div>
                        </div>

                        <div class="mb-6">
                            <label class="block font-medium text-sm text-gray-700">Confirmar Nueva Contraseña</label>
                            <input v-model="form.password_confirmation" type="password" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 mt-1">
                        </div>
